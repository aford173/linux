...
static const struct hantro_fmt imx8mm_vpu_h1_venc_fmts[] = {
	{
		.fourcc = V4L2_PIX_FMT_NV12,
		.codec_mode = HANTRO_MODE_NONE,
...
static const struct hantro_irq imx8mm_h1_irqs[] = {
...
static const char * const imx8mm_h1_clk_names[] = { "h1" };
...
const struct hantro_variant imx8mm_vpu_h1_variant = {
	.enc_fmts = imx8mm_vpu_h1_venc_fmts,
	.num_enc_fmts = ARRAY_SIZE(imx8mm_vpu_h1_venc_fmts),
	.codec = HANTRO_VP8_ENCODER | HANTRO_H264_ENCODER,
	.codec_ops = imx8mm_vpu_h1_codec_ops,
	.irqs = imx8mm_h1_irqs,
	.num_irqs = ARRAY_SIZE(imx8mm_h1_irqs),
