...
static const uint8_t adv7535_register_defaults[] = {
	0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, /* 00 */
	...
	0x80, 0x78, 0x00, 0x00, 0x60, 0x00, 0xfd, 0x00, /* e0 */
...
static const struct regmap_config adv7535_regmap_config = {
	.reg_bits = 8,
	.val_bits = 8,

	.max_register = 0xff,
	.cache_type = REGCACHE_RBTREE,
	.reg_defaults_raw = adv7535_register_defaults,
	.num_reg_defaults_raw = ARRAY_SIZE(adv7535_register_defaults),
			     ...
			     const struct drm_display_mode *adj_mode)
{
	...
	if (adv7511->type == ADV7535)
		regmap_update_bits(adv7511->regmap, 0x4a, 0xc, low_refresh_rate << 2);
	else
		regmap_update_bits(adv7511->regmap, 0xfb, 0x6, low_refresh_rate << 1);

	regmap_update_bits(adv7511->regmap, 0x17,
		0x60, (vsync_polarity << 6) | (hsync_polarity << 5));

	/* If the platform has a fixed number lanes, don't dynamically change them */
	if ((!adv7511->fixed_lanes) && (adv7511->type == ADV7533 || adv7511->type == ADV7535))
...
static int adv7511_probe(struct i2c_client *i2c, const struct i2c_device_id *id)
{
	...
	adv7511->regmap = devm_regmap_init_i2c(i2c, adv7511->type == ADV7535 ? 
					       &adv7535_regmap_config :
